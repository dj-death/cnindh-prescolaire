...
var Service = {
    list: function (params, callback, sid, req) {
        session.verify(req).then(function (session) {
            ...
            return models.Effectif.scope('browse').findAndCountAll(
                helpers.sequelizify(params, models.Effectif));
    ...
    insert: function (params, callback, sid, req) {
        ...
        session.verify(req).then(function (session) {
            ...
            return models.Effectif.create(params, { include: [{ model: models.Unite, as: 'unite' }] });
        }).then(function (row) {
    ...
    update: function (params, callback, sid, req) {
        ...
        session.verify(req).then(function (session) {
            ...
            return models.Effectif.findOne({
                where: {
                    id: params.id
                }
            });
    ...
    filters: function (params, callback, sid, req) {
        session.verify(req).then(function () {
            return helpers.fetchFilters(params, models.Effectif);
    ...
    checklast: function (callback, sid, req) {
        ...
        return models.Effectif.findAll({
            limit: 1,
            where: {},
            attributes: ['updated'],
            order: [['updated', 'DESC']]

        ...
        Model.addScope('nested', {
            ...
            include: [
                { 
                    ...
                    as: 'unites',
                    attributes: [
                        'id', 'province_code', 'plan_actions', 'fondation_partenaire_code', 'commune', 'intitule', 'nbre_salles', 'nbre_salles_ouvertes', 'est_ouverte', 'est_resiliee', 'est_en_arret', 'date_ouverture'
                    ],
